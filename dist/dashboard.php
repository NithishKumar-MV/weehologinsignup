        ...
        <div class="whitebg">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="#" class="list-group-item list-group-item-action bg-transparent text-dark fw-bold">
                    <i class="fas fa-birthday-cake me-2"></i>Personal Parties
                </a>
                <a href="#" class="list-group-item list-group-item-action bg-transparent text-dark fw-bold mleft">
                    <i class="fas fa-star me-2"></i>Personal Ceremony
                </a>
                <a href="#" class="list-group-item list-group-item-action bg-transparent text-dark fw-bold">
                    <i class="fas fa-building me-2"></i>Corporate Parties
                </a>
                <a href="#" class="list-group-item list-group-item-action bg-transparent text-dark fw-bold">
                    <i class="fas fa-gifts me-2"></i>Corporate Celebration
                </a>
                <a href="#" class="list-group-item list-group-item-action bg-transparent text-dark fw-bold">
                    <i class="fas fa-users me-2"></i>MICE Events
                </a>
